...
var (
	pattern_Greeter_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "hello"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Greeter_SayHelloAgain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "helloagain"}, "", runtime.AssumeColonVerbOpt(true)))
)
